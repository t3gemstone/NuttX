...
#define VRING_SIZE          (0x8000)  /* 32 KB per vring */
#define VDEV0_VRING_BASE    (0xa2200000)  /* RPMsg vrings */
#define VDEV1_VRING_BASE    (0xa2210000)  /* virtio-net vrings (= VDEV0 + 2*VRING_SIZE) */
