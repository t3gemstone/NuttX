 ...
 * (CSLR_R5FSS0_CORE0_INTR_MAILBOX0_MAILBOX_CLUSTER_3_MAILBOX_CLUSTER_PEND_3
 *  from mcu_plus_sdk_j722s source/drivers/hw_include/j722s/cslr_intr_r5fss0_core0.h).
 ...
 *   interrupt, and notifies the rptun/OpenAMP stack to process all virqueues.
 *
 ****************************************************************************/
